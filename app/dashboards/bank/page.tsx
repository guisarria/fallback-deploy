    ...
    <div className="flex h-screen w-screen flex-col items-center justify-center lg:flex-row">
        ...
        <div className="flex flex-col justify-around md:flex-row">
          <ul className="flex flex-col items-center space-y-6 border-b pb-6 text-lg md:border-b-0 lg:pb-0 ">
            <li className="flex items-center space-x-4 ">
              <PiggyBank className="h-12 w-12 text-blue-500 blur-[0.8px] dark:text-blue-300" />
              <div>
            ...
            <li className="flex items-center space-x-4">
              <Layout className="h-12 w-12 text-blue-500 blur-[0.8px] dark:text-blue-300" />
              <div>
            ...
            <li className="flex items-center space-x-4">
              <Megaphone className="h-12 w-12 text-blue-500 blur-[0.8px] dark:text-blue-300" />
              <div>
            ...
            <li className="flex items-center space-x-4">
              <Image className="h-12 w-12 text-blue-500 blur-[0.8px] dark:text-blue-300" />
              <div>
            ...
            <li className="flex items-center space-x-6 md:self-start">
              <User className="ml-2 h-12 w-12 text-blue-500 blur-[0.8px] dark:text-blue-300 md:ml-0" />
            ...
            <li className="flex items-center space-x-6 md:self-start">
              <MessageCircle className="h-12 w-12 text-blue-500 blur-[0.8px] dark:text-blue-300" />
              <div>
                <p>Themes</p>
                <Popover>
      ...
      <section className="container z-10 flex h-[500px] flex-col items-center justify-center space-y-4 rounded-lg border-2 bg-background/80 py-4 backdrop-blur-md lg:mx-2 lg:w-[500px]">
        ...
        <p className="px-8 text-center text-base blur-[0.4px]">
          Ask AI everything about bank funds.
        </p>
        <Input
      ...
      <DollarSign className="bottom-100 absolute right-0 h-[800px] w-[800px] stroke-[1] font-serif text-black blur-md dark:text-blue-300" />
    </div>
  )
}
