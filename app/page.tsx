...
export default function IndexPage() {
  return (
    <div className="flex flex-col content-center items-center justify-center">
      ...
      <section
        id="contact"
        className="container z-10 my-10 flex h-[500px] content-center items-center justify-center rounded-none border bg-background/80 backdrop-blur-md md:max-w-[70rem] md:rounded-xl"
      >
